...
2. Test **Mobile** (375×667 - iPhone SE):
   ...
   node ~/.claude/plugins/**/website-debug/skills/website-debug/scripts/browser-screenshot.js --output=/tmp/responsive-mobile.png
   ```

3. Test **Tablet** (768×1024 - iPad):
   ```bash
   node ~/.claude/plugins/**/website-debug/skills/website-debug/scripts/browser-resize.js --tablet
   node ~/.claude/plugins/**/website-debug/skills/website-debug/scripts/browser-screenshot.js --output=/tmp/responsive-tablet.png
   ```

4. Test **Desktop** (1920×1080):
   ```bash
   node ~/.claude/plugins/**/website-debug/skills/website-debug/scripts/browser-resize.js --desktop
   node ~/.claude/plugins/**/website-debug/skills/website-debug/scripts/browser-screenshot.js --output=/tmp/responsive-desktop.png
   ```
